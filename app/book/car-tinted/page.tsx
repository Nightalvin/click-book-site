...
export default function CarTintedBooking() {
  ...
  return (
    <main className="min-h-screen bg-gray-100 flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-white shadow-md rounded p-6 text-center">
        {!submitted ? (
          <>
            <img src="/images/car-tinted.jpg" alt="Car Tinted" className="rounded mb-4 w-full object-cover h-48" />
            <h1 className="text-2xl font-bold mb-4">Book a 🪟 Car Tinted</h1>
          ...
          <>
            ...
            <p className="mb-4">
              🪟 Car Tinted on <strong>{date}</strong> at <strong>{time}</strong><br />
